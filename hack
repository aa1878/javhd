...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:AJI
	    time.sleep(2)
            loop = 'false'
        else:
...
def login():
	...
	try:
		...
		print logo
		print 42*"\033[1;96m="
		print('\033[1;96m[⚡] \x1b[1;93mMasuk Menggunakan Akun Baru \x1b[1;93m[⚡]' )
...
def menu():
	...
	print logo
	print( "•◈•─────────────────────────────────────────────────•◈•"  ) 
	print "  [÷] Name\033[1;32;40m: "+nama+"  	   "                               
	print "  [÷] ID  \033[1;32;40m: "+id+"        "
	print( "•◈•─────────────────────────────────────────────────•◈•") 
