...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print logo
		posts = raw_input("\033[1;97m[*] Post ID : ")
		try:
			jok = requests.get("https://graph.facebook.com/"+posts+"?access_token="+toket)
		...
		r = requests.get("https://graph.facebook.com/"+posts+"/postsid?access_token="+toket)
		z = json.loads(r.text)
		for i in z['data']:
			id.append(i['id'])
	elif peak =="3":
